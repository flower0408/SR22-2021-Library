...
public class Biblioteka {
	...
	public Biblioteka() {
		...
		public Biblioteka(int id, String naziv, String adresa, String telefon, String radnoVreme,
			ArrayList<Zaposleni> sviZaposleni, ArrayList<ClanBiblioteke> clanoviBiblioteke,
			ArrayList<IzdavanjeKnjige> izdavanjeKnjiga, ArrayList<TipClanarine> tipoviClanarine,
			ArrayList<Knjiga> knjige, ArrayList<PrimerakKnjige> primerciKnjiga, ArrayList<ZanrKnjige> zanroviKnjige) {
		super();
		this.id = id;
		this.naziv = naziv;
		this.adresa = adresa;
		...
		public String toString() {
			return "Biblioteka [id=" + id + ", naziv=" + naziv + ", adresa=" + adresa + ", telefon=" + telefon
					+ ", radnoVreme=" + radnoVreme + ", sviZaposleni=" + sviZaposleni + ", clanoviBiblioteke="
					+ clanoviBiblioteke + ", izdavanjeKnjiga=" + izdavanjeKnjiga + ", tipoviClanarine="
					+ tipoviClanarine + ", knjige=" + knjige + ", primerciKnjiga=" + primerciKnjiga + ", zanroviKnjige="
					+ zanroviKnjige + "]";
		}
